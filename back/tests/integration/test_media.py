...
class TestMediaUpload:
    ...
    def test_upload_logo_success_admin(
        self, test_client: TestClient, test_merchant, admin_user
    ):
    ...
    def test_upload_logo_different_formats(
        self, test_client: TestClient, test_merchant, admin_user
    ):
    ...
    def test_upload_logo_staff_forbidden(
        self, test_client: TestClient, test_merchant, staff_user
    ):
    ...
    def test_upload_logo_no_auth(self, test_client: TestClient):
        ...
        response = test_client.post(
            "/api/v1/media/logo", files={"file": ("logo.png", image_data, "image/png")}
        )
    ...
    def test_upload_logo_no_file(
        ...
        response = test_client.post("/api/v1/media/logo", headers=headers)

        # Verify bad request response
        assert response.status_code == 422  # FastAPI validation error

    def test_upload_logo_empty_file(
        self, test_client: TestClient, test_merchant, admin_user
    ):
...
class TestSignedUrl:
    ...
    def test_get_signed_url_admin_success(
        self, test_client: TestClient, test_merchant, admin_user
    ):
        ...
        # Get signed URL
        response = test_client.get("/api/v1/media/logo/signed-url", headers=headers)
    ...
    def test_get_signed_url_staff_success(
        self, test_client: TestClient, test_merchant, admin_user, staff_user
    ):
        ...
        response = test_client.get(
            "/api/v1/media/logo/signed-url", headers=staff_headers
        )
    ...
    def test_get_signed_url_no_logo(
        self, test_client: TestClient, test_merchant, admin_user
    ):
...
class TestLogoDeletion:
    ...
    def test_delete_logo_admin_success(
        self, test_client: TestClient, test_merchant, admin_user
    ):
        ...
        # Delete logo
        response = test_client.delete("/api/v1/media/logo", headers=headers)
    ...
    def test_delete_logo_staff_forbidden(
        ...
        response = test_client.delete("/api/v1/media/logo", headers=staff_headers)
...
class TestMultiTenantIsolation:
    ...
    def test_cross_tenant_upload_isolated(
        self,
        ...
        response = test_client.get("/api/v1/media/logo/signed-url", headers=headers2)
