...
class DeliveryRatesService:
    ...
    async def list_rates(self, merchant_id: UUID, active_only: Optional[bool] = None) -> List[DeliveryRateResponse]:
        """
    ...
    async def update_rate(
        ...
        try:
            ...
            # Update the rate
            stmt = update(DeliveryRate).where(
                and_(
                    DeliveryRate.id == rate_id,
                    DeliveryRate.merchant_id == merchant_id
                )
    ...
    async def get_rate_by_id(self, merchant_id: UUID, rate_id: UUID) -> Optional[DeliveryRateResponse]:
        """
    ...
    async def _validate_can_deactivate_rate(self, merchant_id: UUID, rate_id: UUID) -> None:
        """
