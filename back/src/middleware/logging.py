...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, request_id_header: str = None):
        super().__init__(app)
        self.request_id_header = request_id_header or os.getenv(
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            self._log_response_success(
                request, request_id, route_template, response.status_code, duration_ms
            )
            ...
            HTTP_REQUESTS_TOTAL.labels(
                method=request.method, route=route_template, status_code="500"
            ).inc()
            ...
            self._log_unhandled_exception(
                request, request_id, route_template, duration_ms, e
            )
    ...
    def _log_request_start(
        self, request: Request, request_id: str, route_template: str
    ):
