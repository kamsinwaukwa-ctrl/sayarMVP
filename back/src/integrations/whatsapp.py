...
class WhatsAppIntegration:
    ...
    def __init__(
        self, access_token: Optional[str] = None, phone_number_id: Optional[str] = None
    ):
        """
    ...
    async def send_message(
        ...
        if message_type == "text":
            ...
            data["template"] = {"name": message, "language": {"code": "en"}}
...
async def send_whatsapp_message(
    to: str, message_type: str = "text", content: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
